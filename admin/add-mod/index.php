...
<html lang="ru">
  ...
  <body>
    <div id="add-mod-form" class="add-mod-form"> Добавить мод
      <form action="../add.php" method="post">
        ...
        <input type="hidden" value="hiddenInput-mod" name="hiddenInput-mod">
        <label for="submit">Подтвердить</label>
        <input id="submit" type="submit" name="add-mod" value="Подтвердить">
      </form>
    </div>
